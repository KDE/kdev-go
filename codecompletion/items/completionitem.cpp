...
CompletionItem::CompletionItem(KDevelop::DeclarationPointer decl, KSharedPtr< KDevelop::CodeCompletionContext > context, int inheritanceDepth):
    NormalDeclarationCompletionItem(decl, KSharedPtr<KDevelop::CodeCompletionContext>(), 0),
    m_prefix("")
{
